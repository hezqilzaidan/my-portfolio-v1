<template>
  ...
  <div class="max-w-7xl mx-auto flex flex-col relative">
        ...
        <button @click="redirectToHome" class="flex items-center gap-2">
          <div class="flex items-center gap-2">
            <div class="w-8 h-8 bg-white rounded-full flex items-center justify-center">
              <span class="text-black font-mono text-sm font-bold">&lt;/&gt;</span>
            </div>
            <span class="self-center text-lg text-white font-semibold whitespace-nowrap fadein-bot hover:text-amber-100">LeixCode.</span>
          </div>
        </button>
        <div class="flex md:order-2 fadein-bot">
          <a href="https://www.linkedin.com/in/ahmedhezqialzaidan/" class="block w-9 h-9 rounded-full overflow-hidden hover:opacity-80 transition-opacity duration-200">
            <img class="w-full h-full object-contain" src="https://upload.wikimedia.org/wikipedia/commons/c/ca/LinkedIn_logo_initials.png" alt="linkedin">
          </a>
        </div>
          ...
          <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
            ...
            <li>
              <router-link to="/career"
                class="fadein-bot fadein-3 text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-gray-500 md:p-0 career">Career</router-link>
            </li>
            <li>
              <router-link to="/events"
                class="fadein-bot fadein-3 text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-gray-500 md:p-0 events">Events</router-link>
            </li>
            <!-- <li> -->
              <!-- <router-link to="/blog" -->
    ...
    <div class="md:mt-[100px] relative z-10">
      <router-view />
    </div>
  </div>
  <footer class="block md:hidden fixed bottom-0 left-0 right-0 rounded-t-3xl border border-[#383838] bg-[#121212] bg-opacity-80 backdrop-blur-md backdrop-opacity-90 z-20">
  <nav class="flex justify-around py-4 text-xs">
    ...
    <router-link to="/events" class="text-gray-300 hover:text-white">Events</router-link>
...
export default {
  components: { 
    AnimatedBackground: () => import('./components/AnimatedBackground.vue') 
  },
  methods: {
    redirectToHome() {
      this.$router.push('/')
